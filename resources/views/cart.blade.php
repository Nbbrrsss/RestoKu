                                ...
                                <div class="col mb-4">
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">Harga: Rp. {{ $cartItem->food->harga_promo }}</p>
                                            <p class="card-text">Jumlah: {{ $cartItem->quantity }}</p>
                                        </div>
                                        <div class="card-footer">
                                            <small class="text-muted">
                                                <a href="{{ route('hapus_item', ['id' => $cartItem->id]) }}" class="btn btn-danger">Hapus</a>
                                            </small>
                                        </div>
                                    </div>
                                </div>
                                <?php $totalPrice += $cartItem->food->harga_promo * $cartItem->quantity; ?>
                            @endforeach
                        </div>
